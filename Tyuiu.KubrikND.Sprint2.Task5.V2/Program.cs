...
using Tyuiu.KubrikND.Sprint2.Task5.V2.Lib;

namespace Tyuiu.KubrikND.Sprint2.Task5.V2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Выполнил: Кубрик Н.Д.      | ИСПНб-23-1                                 *");
            Console.WriteLine("***************************************************************************");
            ...
            {
                res = "Этот меcяц принадлежит времени года: " + ds.FindMonthSeason(numMouth);
            }
